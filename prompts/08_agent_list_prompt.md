...
---------------------------------------------------------------
- ENTITY_SINGULAR: Meta Diária
- ENTITY_PLURAL: metas diárias
- DTO_CLASS: DailyGoalDto
- FEATURE_FOLDER: daily_goals
- PAGE_DEFAULT: 1
- PAGE_SIZE_DEFAULT: 20
- MAX_PAGE_SIZE: 100
- SORT_BY_DEFAULT: dateIso        # Ordenação padrão por data de criação (campo no DTO: 'dateIso')
- INCLUDE_HINT: type, completed  # Campos importantes para filtrar/detalhar a Meta
