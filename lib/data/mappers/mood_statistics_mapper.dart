...
class MoodStatisticsMapper {
  ...
  static Map<String, int> _normalizeDistribution(
  ...
  static Map<String, dynamic> _denormalizeDistribution(
  ...
  static List<MoodStatisticsDto> toDtoList(
      List<MoodStatisticsEntity> entities) {
