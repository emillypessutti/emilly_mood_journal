...
class PrivacyPolicyScreen extends StatefulWidget {
  const PrivacyPolicyScreen({super.key, this.enforceAcceptance = false});
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Future<void> _loadSavedConsents() async {
    final acceptedVersion = await PreferencesService.getPolicyVersionAccepted();
    final marketingConsent = await PreferencesService.getConsentMarketing();
    
    if (acceptedVersion == _policyVersion) {
      setState(() {
        // Se já aceitou a versão atual, pré-marca os obrigatórios
        _acceptedTerms = true;
        _acceptedPrivacy = true;
        _acceptedDataProcessing = true;
        _acceptedMarketing = marketingConsent ?? false;
      });
    }
  }
  ...
  Future<void> _continue() async {
    ...
    await PreferencesService.setPolicyAcceptance(
    ...
    // Senão, apenas volta (estava só revisando)
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: !widget.enforceAcceptance,
      child: Scaffold(
        backgroundColor: AppTheme.surfaceColor,
        appBar: AppBar(
          title: const Text('Políticas e Consentimento'),
          automaticallyImplyLeading: !widget.enforceAcceptance,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: Text(
                              widget.enforceAcceptance ? 'Continuar' : 'Salvar',
