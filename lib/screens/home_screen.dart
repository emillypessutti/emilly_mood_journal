...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  */
  ...
  Future<void> _checkPolicyAcceptance() async {
    ...
    if (acceptedVersion != _currentPolicyVersion && mounted) {
      // Navega para a tela de política de privacidade
      await Navigator.of(context).pushNamed('/privacy', arguments: {'enforce': true});
      
      // Após retornar, salva que aceitou a versão atual
      // Persistência é feita na PrivacyPolicyScreen ao clicar em "Continuar".
